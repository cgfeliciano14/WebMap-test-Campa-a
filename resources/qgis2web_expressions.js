...
function exp_Votos_Unidades_1rule0_eval_expression(context) {
    // "Votos PNP" > "Votos PPD"

    var feature = context.feature;
    
    if (feature.properties) {
        return (feature.get('Votos PNP')  > feature.get('Votos PPD') );
    } else {
        return (feature.get('Votos PNP')  > feature.get('Votos PPD') );
    }
}
...
function exp_Votos_Unidades_1rule1_eval_expression(context) {
    // "Votos PPD" > "Votos PNP"

    var feature = context.feature;
    
    if (feature.properties) {
        return (feature.get('Votos PPD')  > feature.get('Votos PNP') );
    } else {
        return (feature.get('Votos PPD')  > feature.get('Votos PNP') );
    }
}
...
function exp_Votos_Unidades_1rule2_eval_expression(context) {
    // "Votos MVC" > "Votos PNP"

    var feature = context.feature;
    
    if (feature.properties) {
        return (feature.get('Votos MVC')  > feature.get('Votos PNP') );
    } else {
        return (feature.get('Votos MVC')  > feature.get('Votos PNP') );
    }
}
...
function exp_Votos_Unidades_1rule3_eval_expression(context) {
    // "Votos PNP" = "Votos PPD"
